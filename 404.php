...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <h1 class="message__title">Seite nicht gefunden</h1>
      <p class="message__text">
      Es tut uns leid, die von Ihnen gesuchte Seite wird hier nicht gefunden. Der Link, dem Sie gefolgt sind, ist möglicherweise defekt oder existiert nicht mehr. Bitte versuchen Sie es erneut oder werfen Sie einen Blick in unsere.
        </p>
    </div>
